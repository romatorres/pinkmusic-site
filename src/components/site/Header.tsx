...
export default function Header() {
  return (
    <header className="absolute top-0 left-0 right-0 z-10 flex min-h-[124px] w-full flex-col items-stretch justify-center px-60 py-7 max-md:max-w-full max-md:px-5">
